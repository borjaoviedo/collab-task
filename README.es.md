...
Ejecutar las suites de pruebas mediante los scripts unificados:
...
- Las pruebas de integración validan persistencia, concurrencia y comportamiento de endpoints.  
